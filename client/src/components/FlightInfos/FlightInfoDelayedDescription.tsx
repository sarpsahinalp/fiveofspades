...
function FlightInfoDelayedDescritpion({ flightModel, seat }: Props) {
    return (
        <Container className={"p-0"}>
                ...
                <Row style = {{borderBottom: "1px solid lightgray", backgroundColor: "lightgray"}} className={"m-0"}>
                    <Col style = {{paddingTop: "0.75rem", paddingBottom: "0.75rem", backgroundColor: "red"}}>
                        <span style={{color: "white"}}>FLIGHT DELAYED <FaExclamationTriangle /></span>
                    </Col>
                </Row>
                <Row style = {{borderBottom: "1px solid lightgray", paddingBottom:"0.4rem", paddingTop:"0.4rem"}} className={"m-0"}>
                    <Col style = {{borderRight: "1px solid lightgray"}}>
...
export default FlightInfoDelayedDescritpion;
